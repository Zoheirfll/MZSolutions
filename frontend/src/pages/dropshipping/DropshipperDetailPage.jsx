...
function CommissionRow({ dropshipperId, item, commission, onSaved }) {
  ...
  const inputCls = 'w-28 px-2.5 py-1.5 rounded-lg border text-sm text-app-primary bg-transparent outline-none focus:border-violet-500 transition [color-scheme:dark]'
  ...
  return (
    <tr className="border-b hover:bg-violet-500/5 transition" style={{ borderColor: theme.dark.borderRowHover }}>
      ...
      <td className="px-4 py-3 text-app-muted-light">{money(item.product_price)}</td>
