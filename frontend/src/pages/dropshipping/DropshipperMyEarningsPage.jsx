...
export default function DropshipperMyEarningsPage() {
  ...
  return (
    <DashboardLayout title="Mes commissions">
      ...
      <h2 className="font-semibold text-app-primary mb-3">Historique des commissions</h2>
        ...
        <table className="w-full text-sm min-w-140">
          ...
          <tbody>
            {detail.entries.length === 0 ? (
              <tr><td colSpan={4} className="px-4 py-8 text-center text-sm text-app-muted">Aucune commission calculée pour l'instant — elle apparaît dès qu'une de vos commandes passe au statut « Livrée ».</td></tr>
      ...
      <h2 className="font-semibold text-app-primary mb-3">Historique des paiements reçus</h2>
        ...
        <table className="w-full text-sm min-w-140">
          ...
          <tbody>
            {detail.payments.length === 0 ? (
              <tr><td colSpan={3} className="px-4 py-8 text-center text-sm text-app-muted">Aucun paiement reçu pour l'instant.</td></tr>
