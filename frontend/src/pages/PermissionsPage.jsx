...
export default function PermissionsPage() {
  ...
  return (
    <DashboardLayout title="Permissions par rôle">
      <p className="text-sm mb-5" style={{ color: theme.dark.muted }}>
        Personnalise ce que chaque rôle peut voir dans le tableau de bord. Les actions de création/modification/suppression restent toujours réservées au propriétaire et aux administrateurs, quel que soit ce réglage.
      </p>
